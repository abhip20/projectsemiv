      ...
      {openModel && (
        <div className={Style.modelBox}>
          <Model
            ...
            info="TEXTZ is the best place to send your messages. Dont worry your Messages are secure"
            smallInfo="Tell us your name"
            image={images.hero}
